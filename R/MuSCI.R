#' The main algorithm multi-source conformal inference (MuSCI)
#' @param data.train training data, a data.frame() objective with defined variable names
#' @param data.test  testing data, which should have the same structure as the training data
#' @param alpha desired coverage level of the prediction intervals
#' @param Y.name name of outcome in the training and testing data
#' @param T.name name of the site variable in training data
#' @param tgt.site.name name of the target site
#' @param ps.Library SuperLearner library for fitting the propensity score;
#'                   use SuperLearner::listWrappers() to see all possible choices
#' @param m.Library SuperLearner library for fitting the putative cdf of conformal score;
#'                  use SuperLearner::listWrappers() to see all possible choices
#' @param p1 proportion of training data used for nuisance function training, default value 0.5
#' @param seed seed for random sampling when splitting data
